...
export default function LocalGroupsChart() {
  ...
  const sortedGroups = [...groupsData].sort((a, b) => {
    if (sortBy === 'members') {
      ...
      return (a.country || a.residence_country || '').localeCompare(b.country || b.residence_country || '', 'da');
    }
    return 0;
  });
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <MapPin className="text-adopteez-primary" size={28} />
            <h2 className="text-2xl font-bold text-gray-900">Lokale Grupper</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4">
            <p className="text-sm font-medium text-blue-600 mb-1">Antal lokale grupper</p>
            <p className="text-3xl font-bold text-blue-900">{stats.totalGroups}</p>
          </div>

          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4">
            <p className="text-sm font-medium text-green-600 mb-1">Totalt antal medlemmer</p>
            <p className="text-3xl font-bold text-green-900">{stats.totalMembers}</p>
          </div>

          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4">
            <p className="text-sm font-medium text-purple-600 mb-1">Gennemsnit per gruppe</p>
      ...
      <div className="p-6">
        {sortedGroups.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Ingen lokale grupper fundet</p>
          </div>
        ) : (
          <div className="space-y-3">
            {sortedGroups.map((group, index) => {
              const percentage = (group.memberCount / maxMembers) * 100;
              const country = group.country || group.residence_country || 'Ukendt';
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            ...
                            {group.group_type === 'adopted' && (
                              <span className="px-2 py-0.5 bg-purple-100 text-purple-700 text-xs rounded-full font-medium">
                                Adopterede
                              </span>
                            )}
                            {group.group_type === 'parents' && (
